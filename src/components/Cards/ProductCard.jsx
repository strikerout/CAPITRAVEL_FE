  ...
  return (
    <Link to={`/product/${id}`} className={styles.productCard}>
      <div className={styles.productImg + " productImg"}>
        <img
          src="https://i.pinimg.com/originals/56/dd/e4/56dde41aee17e96425987f751a9269ce.jpg"
          alt=""
        />
      </div>
      <div className={styles.cardTitles + " cardTitles"}>
        <h4>{title === undefined ? "[Experience Example: short description and details.]" : title }</h4>
